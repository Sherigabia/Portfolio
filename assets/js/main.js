...
}).type("Web Developer",{delay: 400}).pause(500).delete(13).type("UI/UX Designer",{delay:400}).pause(500).delete(14).type("Mobile App Developer",{delay:400}).pause(500).delete(20).type("Game Developer",{delay:400}).pause(500).delete(14).type("Tech Enthusiast",{delay:400}).pause(500).delete(9).go();
...
//email sending
 window.onload = function() {
            document.getElementById('contact-form').addEventListener('submit', function(event) {
                ...
                emailjs.sendForm("service_dx660t8","template_mqpayv4", this)
                    .then(function() {
                        console.log('SUCCESS!');
                    }, function(error) {
